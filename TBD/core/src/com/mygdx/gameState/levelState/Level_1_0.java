...
public class Level_1_0 extends LevelState{
	ShapeRenderer shaperenderer = new ShapeRenderer();
//	private BitmapFont font = new BitmapFont();
	private Bob bob;


	private String levelDataDir = "/levelData/Level0/Level_0_data.xml";
	private String enemyDataDir = "/levelData/Level0/EnemyData_Level0.xml";

	
	public Level_1_0(LevelStateManager lsm) {
		super(lsm);
	...
	public void init() {
		...
		MusicBox.play("Melody");
		MusicBox.loop("Melody", true);
//		setMap(new TmxMapLoader().load(levelFileReader.getMapDir()));
		setMap(new TmxMapLoader().load(("map/level_1.tmx")));
...
//		enemyList = new Enemy[levelFileReader.getEnemyNum()];		
		...
		bob = new Bob(new Vector2(544, 40));
