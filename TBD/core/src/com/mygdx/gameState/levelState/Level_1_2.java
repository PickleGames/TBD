...
public class Level_1_2 extends LevelState{
	ShapeRenderer shaperenderer = new ShapeRenderer();
//	private BitmapFont font = new BitmapFont();
	private Bob bob;


	private String levelDataDir = "/levelData/Level0/Level_2_data.xml";
	private String enemyDataDir = "/levelData/Level0/EnemyData_Level2.xml";

	
	public Level_1_2(LevelStateManager lsm) {
		super(lsm);
	...
	@Override
	public void init() {
		lsm.setCurrentLevel(LevelStateManager.LEVEL1_2);
		
		MusicBox.play("Alah_Remix");
		MusicBox.loop("Alah_Remix", true);
		setMap(new TmxMapLoader().load("map/level_3.tmx"));
...
//		enemyList = new Enemy[levelFileReader.getEnemyNum()];		
		...
		bob = new Bob(new Vector2(960, 832));
